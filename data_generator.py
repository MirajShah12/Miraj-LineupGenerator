...
class DataGenerator:
    ...
    def create_test_data(self, team_name: str = "Test Team") -> List[PlayerModel]:
        ...
        """
        test_data = {
            'Name': ['Aaron Judge', 'Giancarlo Stanton', 'DJ LeMahieu', 'Anthony Rizzo', 'Gleyber Torres',
                     'Jazz Chisholm Jr.', 'Juan Soto', 'Alex Verdugo', 'Austin Wells'],
            'Team': [team_name] * 9,
            'PA': [700, 650, 600, 580, 550, 520, 680, 590, 400],
            '1B': [90, 70, 85, 75, 80, 65, 95, 70, 45],
            '2B': [25, 30, 20, 22, 18, 15, 28, 20, 12],
            '3B': [2, 1, 3, 1, 2, 4, 1, 3, 2],
            'HR': [45, 35, 15, 20, 25, 18, 40, 12, 8],
            'BB': [80, 60, 70, 65, 55, 45, 90, 60, 40],
            'HBP': [8, 5, 6, 7, 4, 3, 9, 5, 3],
            'SO': [150, 180, 120, 140, 130, 160, 140, 145, 110],
            'GDP': [8, 12, 15, 10, 8, 6, 5, 9, 4],
            'wOBA': [0.380, 0.350, 0.320, 0.330, 0.340, 0.315, 0.390, 0.300, 0.280],
            'OBP': [0.385, 0.345, 0.335, 0.340, 0.345, 0.320, 0.395, 0.305, 0.285],
            'SLG': [0.580, 0.520, 0.420, 0.450, 0.480, 0.410, 0.590, 0.380, 0.350],
            'xwOBA': [0.375, 0.345, 0.315, 0.325, 0.335, 0.310, 0.385, 0.295, 0.275],
            'xBA': [0.280, 0.250, 0.260, 0.265, 0.270, 0.245, 0.290, 0.255, 0.240],
            'xSLG': [0.570, 0.510, 0.410, 0.440, 0.470, 0.400, 0.580, 0.370, 0.340],
            'ISO': [0.200, 0.175, 0.160, 0.185, 0.135, 0.165, 0.200, 0.075, 0.070]
        }
